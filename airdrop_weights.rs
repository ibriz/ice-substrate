...
//! DATE: 2022-03-29, STEPS: `20`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_airdrop::WeightInfo for WeightInfo<T> {
	...
	fn remove_from_pending_queue(b: u32, ) -> Weight {
		(33_156_000 as Weight)
			// Standard Error: 0
